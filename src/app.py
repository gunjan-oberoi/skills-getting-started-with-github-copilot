...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for league play and practice",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, learn techniques, and prepare for swim meets",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, improvise, and perform school plays",
